rule _ImplantCozy {
   meta:
      description = "ImplantCozy binary rule from the CozyBear collection"
      author = "Krkn"
      date = "2020-05-24"
   strings:
      $mz = {4d 5a}
      ...
      $x1 = "Grv~Y(" fullword ascii
      $x2 = "G+;u:" fullword ascii
      $x3 = "G W@" fullword ascii
      $x4 = "GT.1" fullword ascii
   condition:
      ( $mz at 0) and
